...
> 本文件由 GitHub Actions 自动生成,是全部算法的分类索引。以下为目录总览(分类名已汉化,链接锚点保持原样);各分类下的完整算法文件列表见正文。

## 目录
1. [音频滤波器](#audio-filters)
2. [回溯](#backtracking)
...
12. [数字图像处理](#digital-image-processing)
13. [分治](#divide-and-conquer)
14. [文档](#docs)
15. [动态规划](#dynamic-programming)
16. [电子学](#electronics)
17. [文件传输](#file-transfer)
18. [金融](#financial)
19. [分形](#fractals)
20. [模糊逻辑](#fuzzy-logic)
21. [遗传算法](#genetic-algorithm)
22. [大地测量](#geodesy)
23. [几何](#geometry)
24. [图形](#graphics)
25. [图论](#graphs)
26. [贪心算法](#greedy-methods)
27. [哈希](#hashes)
28. [背包问题](#knapsack)
29. [线性代数](#linear-algebra)
30. [线性规划](#linear-programming)
31. [机器学习](#machine-learning)
32. [数学](#maths)
33. [矩阵](#matrix)
34. [网络流](#networking-flow)
35. [神经网络](#neural-network)
36. [其他](#other)
37. [物理](#physics)
